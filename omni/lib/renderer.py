...
def get_registry_path():
    return settings.get_governance_path("registry/projects/PROJECT_REGISTRY_MASTER.md")
...
def regenerate_registry(path=None):
    if path is None:
        path = get_registry_path()
...
# Infrastructure Project Registry — Master (V2)
