...
def check_federation_tunnels() -> Dict[str, Any]:
    """Check tunnels managed by Federation Heart."""
    try:
        from federation_heart.clients.connectivity.tunnel_manager import TunnelManager
        ...
        return {
            "available": False,
            "error": "TunnelManager not available"
        }
    except Exception as e:
        return {
            "available": False,
...
def get_tunnel_details(tunnel_name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        manager = TunnelManager()
        details = manager.get_tunnel_status(tunnel_name)
...
def start_tunnel(tunnel_name: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        manager = TunnelManager()
        result = manager.create_tunnel(tunnel_name, config)
